...
const WrappedField = (props) => {
  const { label, children, helptext, required, id, disabled, infoText, onClick, ...rest } = props
  ...
  return (
    <div>
      <label className='usa-label'>
        ...
        {infoText && (
          <div className='tooltip'>
            <img className='fa' src={require('./img/info.svg')} alt='' />
      ...
      {
        {
          string: <Field className={`usa-input ${disabledClass}`} disabled={disabled} {...rest} />,
          url: <Field className={`usa-input ${disabledClass}`} disabled={disabled} {...rest} />,
          select: (
