      ...
      <div className='usa-form-custom'>
        <section id='section-basic-mega-menu' className='site-component-section'>
          ...
          <p className='site-text-intro'>
            ...
            free to only answer what applies. For more information about the form fields, consult
            the <a href='https://resources.data.gov/schemas/dcat-us/v1.1/'>DCAT-US Schema</a>
          </p>
        </section>
        <div className='row'>
          <div className='col-md-12'>
            <WrappedField
              ...
              helptext=<HelpText>
                Main thematic category of the dataset. If this dataset should be included in
                geoplatform.gov, please enter “geospatial” as the theme. Start typing to add themes.
              </HelpText>
        ...
        <div className='row'>
          <div className='col-md-12'>
            <WrappedField
              ...
              placeholder=''
              helptext=''
              infoText=<helpText>Please include "http://" at the beginning of your URL.</helpText>
