#!/bin/bash
# Copied from https://github.com/GSA/USMetadata/blob/master/bin/travis-build.bash
set -e
...
sudo apt-get install solr-jetty libcommons-fileupload-java libpq-dev postgresql-9.6 postgresql-contrib-9.6 redis-server
